      ...
      <form class="form form--add-lot container<?php if ($errors): ?> form--invalid"<?php endif; ?> action="/add.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form__container-two">
          ...
          <div class="form__item<?php if (array_key_exists('category', $errors)): ?> form__item--invalid<?php endif; ?>">
            ...
            <?php if (array_key_exists('category', $errors)): ?><span class="form__error"><?= $errors['category'] ?></span><?php endif; ?>
        ...
        <div class="form__item form__item--wide<?php if (array_key_exists('message', $errors)): ?> form__item--invalid<?php endif; ?>">
          ...
          <?php if (array_key_exists('category', $errors)): ?><span class="form__error"><?= $errors['message'] ?></span><?php endif; ?>
          
        </div>
        <div class="form__item form__item--file<?php if (array_key_exists('lot-image', $errors)): ?> form__item--invalid<?php endif; ?>">
          <label>Изображение <sup>*</sup></label>
          <div class="form__input-file">
            <input class="visually-hidden" name="lot-image" type="file" id="lot-img" value="">
            <label for="lot-img">
              Добавить
            </label>
            <?php if (array_key_exists('message', $errors)): ?><span class="form__error"><?= $errors['lot-image'] ?></span><?php endif; ?>
          </div>
        </div>
        <div class="form__container-three">
          <div class="form__item form__item--small<?php if (array_key_exists('lot-rate', $errors)): ?> form__item--invalid<?php endif; ?>">
            ...
            <?php if (array_key_exists('message', $errors)): ?><span class="form__error"><?= $errors['lot-rate'] ?></span><?php endif; ?>
          </div>
          <div class="form__item form__item--small<?php if (array_key_exists('lot-step', $errors)): ?> form__item--invalid<?php endif; ?>">
            ...
            <?php if (array_key_exists('lot-rate', $errors)): ?><span class="form__error"><?= $errors['lot-step'] ?></span><?php endif; ?>
          </div>
          <div class="form__item<?php if (array_key_exists('lot-date', $errors)): ?> form__item--invalid<?php endif; ?>">
            ...
            <?php if (array_key_exists('lot-step', $errors)): ?><span class="form__error"><?= $errors['lot-date'] ?></span><?php endif; ?>
          </div>
        </div>
